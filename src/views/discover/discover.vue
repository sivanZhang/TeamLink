  ...
  <div class="container main warp-pb">
    ...
    <div class="row swipe-warp">
      <van-swipe :height="200" :autoplay="3000" indicator-color="#009999">
        <van-swipe-item v-for="(item, index) in agentList" :key="index">
          <img class="swipe-img" :src="item[0].images[0]" @click.passive="target(item[0].propertyId)">>
        </van-swipe-item>
      </van-swipe>
    </div>
    <div class="group">
      <div @click.passive="$router.push('/agent')">
        <img src="@/assets/s1.png" alt>
      </div>
      <!-- <router-link tag="div" to="/agent">
        <img src="@/assets/s1.png" alt>
      </router-link> -->
      <div @click.passive="$router.push('/inspection')">
        <img src="@/assets/s4.png" alt>
      </div>
      <div>
        <img src="@/assets/s3.png" alt @click.passive="getHtml(`http://www.home789.com/gfembed/?f=86`)">
      </div>
      <!-- <router-link tag="div" to="/agent">
