      ...
      <div class="car-content">
        ...
        <div style="position: relative; max-height: 475px; overflow: hidden scroll;">
          <div class="near-location-info"><span>Food</span>
            <ul>
              <li class="dotted-left">Potbelly Sandwich Shop</li>
              <li class="dotted-right"><span>121.43 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Health</span>
            <ul>
              <li class="dotted-left">CVS Pharmacy</li>
              <li class="dotted-right"><span>126.08 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Store</span>
            <ul>
              <li class="dotted-left">Target Mobile</li>
              <li class="dotted-right"><span>126.08 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Food</span>
            <ul>
              <li class="dotted-left">Pizza Hut Express</li>
              <li class="dotted-right"><span>126.08 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Food</span>
            <ul>
              <li class="dotted-left">Target</li>
              <li class="dotted-right"><span>126.08 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Health</span>
            <ul>
              <li class="dotted-left">Carolyn J. Wikstrom, PharmD</li>
              <li class="dotted-right"><span>134.46 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Health</span>
            <ul>
              <li class="dotted-left">Jennifer A. Hansen, PharmD</li>
              <li class="dotted-right"><span>134.46 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Food</span>
            <ul>
              <li class="dotted-left">Five Guys</li>
              <li class="dotted-right"><span>134.59 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Store</span>
            <ul>
              <li class="dotted-left">Rug&amp;Decor</li>
              <li class="dotted-right"><span>166.6 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Food</span>
            <ul>
              <li class="dotted-left">Uncle Julio's Mexican From Scratch</li>
              <li class="dotted-right"><span>167.44 m</span></li>
            </ul>
          </div>
          <div class="near-location-info"><span>Store</span>
            <ul>
              <li class="dotted-left">Discovery Clothing</li>
              <li class="dotted-right"><span>185.1 m</span></li>
            </ul>
          </div>
